...
class Profanity {
  ...
  constructor(options = {}) {
    Object.assign(this, {
      ...
      list: options.emptyList && [] || Array.prototype.concat.apply(this.isCorrectLang(options.lang)? require('./languages/' + options.lang + '.json') : require('./languages/en.json'), [options.list || []]),
